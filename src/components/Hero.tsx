      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center rounded-full border border-sarura-100 bg-sarura-50/50 px-4 py-1.5 text-sm font-medium text-sarura-600 mb-6 opacity-0" ref={headingRef}>
              <span className="flex h-2 w-2 rounded-full bg-sarura-500 mr-2"></span>
              Transforming Farming with Technology
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold tracking-tight text-gray-900 leading-tight opacity-0" ref={headingRef}>
              Revolutionize Your <span className="text-sarura-500">Farming</span> with AI-Powered Solutions
            </h1>
            
            <p className="text-lg md:text-xl text-gray-600 max-w-lg opacity-0" ref={paragraphRef}>
              Sarura combines drone technology and artificial intelligence to detect plant diseases early, monitor plantations in real-time, and apply targeted treatments automatically.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 pt-4 opacity-0" ref={ctaRef}>
              <a 
                href="#download" 
