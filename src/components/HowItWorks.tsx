...
const HowItWorks = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Continuous monitoring and detailed reports help you track farm health and treatment effectiveness."
    }
  ];
    ...
    <section id="how-it-works" className="py-20 relative" ref={sectionRef}>
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16 section-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">How Sarura Works</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="lg:order-2 section-fade-in">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img 
                src="https://images.unsplash.com/photo-1487887235947-a955ef187fcc?auto=format&fit=crop&w=1200&h=800&q=80" 
                alt="Drone scanning farm fields" 
                className="w-full h-auto"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-sarura-500/40 to-transparent">
              ...
              {steps.map((step, index) => (
                ...
                >
                  <span className="absolute flex items-center justify-center w-8 h-8 bg-sarura-100 rounded-full -left-4 ring-4 ring-white">
                    <Check className="w-4 h-4 text-sarura-500" />
                  </span>
