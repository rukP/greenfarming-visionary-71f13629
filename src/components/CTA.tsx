...
const CTA = () => {
  ...
  const images = [
    ...
    "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?fm=jpg",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="glass rounded-3xl overflow-hidden shadow-2xl border border-sarura-200/30">
          <div className="p-8 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-sarura-500">
                Ready to Transform Your Farming Experience?
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Download the Sarura app today and start utilizing the power of
                AI to revolutionize your agricultural practices.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <a
                  href="#"
                  className="btn-hover flex items-center justify-center bg-sarura-500 text-white px-6 py-3 rounded-full text-base font-medium shadow-lg shadow-sarura-500/20 hover:bg-sarura-600 transition-colors"
                >
                ...
                <a
                  href="#"
                  className="btn-hover flex items-center justify-center bg-gray-900 text-white px-6 py-3 rounded-full text-base font-medium shadow-lg shadow-gray-900/20 hover:bg-gray-800 transition-colors"
                >
